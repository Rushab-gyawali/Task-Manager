...
{
    public class ConvertToNepali : IConvertToNepali
    {
        public NepaliDate GetNepaliDate(DateTime enDate)
        {
            ...
            npDate.npMonth = (npMonth < 10 ? "0" + npMonth.ToString() : npMonth.ToString());
            npDate.npDay = (npDay < 10 ? "0" + npDay.ToString() : npDay.ToString());
