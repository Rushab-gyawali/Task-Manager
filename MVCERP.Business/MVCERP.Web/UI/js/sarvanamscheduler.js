function srmXMLLoaderObject(e, t, i, s) {
...
function _sarvanamError(e, t, i) {
    return this.catches || (this.catches = []), this
}

function sarvanamHeir(e, t) {
...
function dataProcessor(e) {
    ...
    }, this.enableUTFencoding(!0), sarvanamEventable(this), this
}
window.sarvanamScheduler = window.scheduler = {
    version: "1.0.0"
}, window.sarvanam || (sarvanam = function (e) {
    for (var t in e) sarvanam[t] = e[t];
    return sarvanam
}), sarvanam.extend_api = function (e, t, i) {
    var s = window[e];
    s && (window[e] = function (e) {
        var i;
        if (e && "object" == typeof e && !e.tagName) {
            i = s.apply(this, t._init ? t._init(e) : arguments);
            for (var a in sarvanam) t[a] && this[t[a]](sarvanam[a]);
            for (var a in e) t[a] ? this[t[a]](e[a]) : 0 === a.indexOf("on") && this.attachEvent(a, e[a]);

        } else i = s.apply(this, arguments);
        return t._patch && t._patch(this), i || this
    }, window[e].prototype = s.prototype, i && sarvanamHeir(window[e].prototype, i))
}, sarvanamAjax = {
    get: function (e, t) {
        var i = new srmXMLLoaderObject(!0);
        return i.async = arguments.length < 3, i.waitCall = t, i.loadXML(e), i
    },
    post: function (e, t, i) {
        var s = new srmXMLLoaderObject(!0);
...
}, srmXMLLoaderObject.count = 0,
    srmXMLLoaderObject.prototype.waitLoadFunction = function (e) {
        var t = !0;
        return this.check = function () {
            if (e && e.onloadAction && (!e.xmlDoc.readyState || 4 == e.xmlDoc.readyState)) {
                if (!t) return;
                t = !1, srmXMLLoaderObject.count++, "function" == typeof e.onloadAction && e.onloadAction(e.mainObject, null, null, null, e), e.waitCall && (e.waitCall.call(this, e), e.waitCall = null)
            }
        }, this.check
    }, srmXMLLoaderObject.prototype.getXMLTopNode = function (e, t) {
        var i;
        ...
        return sarvanamError.throwError("LoadXML", "Incorrect XML", [t || this.xmlDoc, this.mainObject]), document.createElement("DIV")
    }, srmXMLLoaderObject.prototype.loadXMLString = function (e, t) {
    ...
    }, srmXMLLoaderObject.prototype.loadXML = function (e, t, i, s) {
        this.rSeed && (e += (-1 != e.indexOf("?") ? "&" : "?") + "a_sar_rSeed=" + (new Date).valueOf()), this.filePath = e,
            this.xmlDoc = !_isIE && window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"), this.async && (this.xmlDoc.onreadystatechange = new this.waitLoadFunction(this)), "string" == typeof t ? this.xmlDoc.open(t, e, this.async) : this.xmlDoc.open(t ? "POST" : "GET", e, this.async), s ? (this.xmlDoc.setRequestHeader("User-Agent", "sarvanamRPC v0.1 (" + navigator.userAgent + ")"), this.xmlDoc.setRequestHeader("Content-type", "text/xml")) : t && this.xmlDoc.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
    ...
    }, srmXMLLoaderObject.prototype.destructor = function () {
    ...
    }, srmXMLLoaderObject.prototype.xmlNodeToJSON = function (e) {
    ...
    _isChrome = !1, _FFrv = !1, _KHTMLrv = !1, _OperaRv = !1, -1 != navigator.userAgent.indexOf("Macintosh") && (_isMacOS = !0), navigator.userAgent.toLowerCase().indexOf("chrome") > -1 && (_isChrome = !0), -1 != navigator.userAgent.indexOf("Safari") || -1 != navigator.userAgent.indexOf("Konqueror") ? (_KHTMLrv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Safari") + 7, 5)), _KHTMLrv > 525 ? (_isFF = !0, _FFrv = 1.9) : _isKHTML = !0) : -1 != navigator.userAgent.indexOf("Opera") ? (_isOpera = !0, _OperaRv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Opera") + 6, 3))) : -1 != navigator.appName.indexOf("Microsoft") ? (_isIE = !0, -1 == navigator.appVersion.indexOf("MSIE 8.0") && -1 == navigator.appVersion.indexOf("MSIE 9.0") && -1 == navigator.appVersion.indexOf("MSIE 10.0") || "BackCompat" == document.compatMode || (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8 : (_isFF = !0, _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])), srmXMLLoaderObject.prototype.doXPath = function (e, t, i, s) {
        ...
        if (_isIE) return t || (t = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML),
            t || sarvanamError.throwError("LoadXML", "Incorrect XML", [t || this.xmlDoc, this.mainObject]), i && t.setProperty("SelectionNamespaces", "xmlns:xsl='" + i + "'"), "single" == s ? t.selectSingleNode(e) : t.selectNodes(e) || new Array(0);
        var a = t;
        t || (t = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML), t || sarvanamError.throwError("LoadXML", "Incorrect XML", [t || this.xmlDoc, this.mainObject]), -1 != t.nodeName.indexOf("document") ? a = t : (a = t, t = t.ownerDocument);
        ...
        return r
    }, _sarvanamError.prototype.catchError = function (e, t) {
        this.catches[e] = t
    }, _sarvanamError.prototype.throwError = function (e, t, i) {
    ...
    }, window.sarvanamError = new _sarvanamError,
    srmXMLLoaderObject.prototype.doXPathOpera = function (e, t) {
    ...
    }, srmXMLLoaderObject.prototype._filterXPath = function (e, t) {
        for (var i = [], t = t.replace(/[^\[]*\[\@/g, "").replace(/[\[\]\@]*/g, ""), s = 0; s < e.length; s++) e[s].getAttribute(t) && (i[i.length] = e[s]);

        return i
    }, srmXMLLoaderObject.prototype._getAllNamedChilds = function (e, t) {
        var i = [];
        ...
        return i
    }, "undefined" == typeof window.sarvanamEvent && (window.sarvanamEvent = function (e, t, i) {
        e.addEventListener ? e.addEventListener(t, i, !1) : e.attachEvent && e.attachEvent("on" + t, i);

    }), srmXMLLoaderObject.prototype.xslDoc = null, srmXMLLoaderObject.prototype.setXSLParamValue = function (e, t, i) {
    ...
    }, srmXMLLoaderObject.prototype.doXSLTransToObject = function (e, t) {
        ...
        obj.attachEvent = function (e, t, i) {
            ...
            var sar_catch = [],
                z = function () {
                    for (var e = !0, t = 0; t < sar_catch.length; t++)
                        if (sar_catch[t]) {
                            var i = sar_catch[t].apply(obj, arguments);
            ...
            return z.addEvent = function (ev) {
                return "function" != typeof ev && (ev = eval(ev)), ev ? sar_catch.push(ev) - 1 : !1
    ...
    }, window.sarvanam || (window.sarvanam = {}),
    function () {
        function e(e, t) {
            var s = e.callback;
        ...
        function t(t) {
            if (c) {
                ...
                return sarvanam.message.keyboard && ((13 == i || 32 == i) && e(c, !0), 27 == i && e(c, !1)), t.preventDefault && t.preventDefault(), !(t.cancelBubble = !0)
            }
        }

        function i(e) {
            i.cover || (i.cover = document.createElement("DIV"), i.cover.onkeydown = t, i.cover.className = "sar_modal_cover", document.body.appendChild(i.cover));
        ...
        function s(e, t, i) {
            var s = i ? i : e || "",
                a = "sarvanam_" + s.toLowerCase().replace(/ /g, "_") + "_button";

            return "<div class='sarvanam_popup_button " + a + "' result='" + t + "' ><div>" + e + "</div></div>"
        }

        function a(e) {
            u.area || (u.area = document.createElement("DIV"), u.area.className = "sarvanam_message_area", u.area.style[u.position] = "5px", document.body.appendChild(u.area)), u.hide(e.id);
            var t = document.createElement("DIV");
            return t.innerHTML = "<div>" + e.text + "</div>", t.className = "sarvanam-info sarvanam-" + e.type, t.onclick = function () {
                u.hide(e.id), e = null
        ...
        function n(t, i, a) {
            ...
            n.className = " sarvanam_modal_box sarvanam-" + t.type, n.setAttribute("sarbox", 1);
            var r = "";
            if (t.width && (n.style.width = t.width), t.height && (n.style.height = t.height), t.title && (r += '<div class="sarvanam_popup_title">' + t.title + "</div>"), r += '<div class="sarvanam_popup_text"><span>' + (t.content ? "" : t.text) + '</span></div><div  class="sarvanam_popup_controls">',
                i) {
            ...
            return n.onclick = function (i) {
                ...
                if (s.className || (s = s.parentNode), "sarvanam_popup_button" == s.className.split(" ")[0]) {
        ...
        function r(e, s, a) {
            ...
            return r.style.top = "top" == e.position ? "-3px" : o + "px",
                r.style.left = d + "px", r.onkeydown = t, r.focus(), e.hidden && sarvanam.modalbox.hide(r), r
        }
        ...
        document.attachEvent ? document.attachEvent("onkeydown", t) : document.addEventListener("keydown", t, !0),
            sarvanam.alert = function () {
                var e = h.apply(this, arguments);
                return e.type = e.type || "confirm", d(e)
            }, sarvanam.confirm = function () {
                var e = h.apply(this, arguments);
                return e.type = e.type || "alert", o(e)
            }, sarvanam.modalbox = function () {
                var e = h.apply(this, arguments);
                return e.type = e.type || "alert", l(e)
            }, sarvanam.modalbox.hide = function (e) {
                for (; e && e.getAttribute && !e.getAttribute("sarbox") ;) e = e.parentNode;
                e && (e.parentNode.removeChild(e), i(!1))
            };
        var u = sarvanam.message = function (e, t, i, s) {
        ...
        serialize: function (e, t) {
            ...
            return i.push("ids=" + this.escape(s.join(","))), sarvanam.security_key && i.push("sar_security=" + sarvanam.security_key), i.join("&")
        },
        ...
        _sendData: function (e, t) {
            if (e) {
                ...
                var i = new srmXMLLoaderObject(function (i, s, a, n, r) {
                    var d = [];
                    if (t) d.push(t);
                    else if (e)
                    ...
                    s = this.serverProcessor + (this._user ? getUrlSymbol(this.serverProcessor) + ["sar_user=" + this._user, "sar_version=" + this.obj.getUserData(0, "version")].join("&") : "");
        ...
        getUpdates: function (e, t) {
            return this._update_busy ? !1 : (this._update_busy = !0, this._loader = this._loader || new srmXMLLoaderObject(!0), this._loader.async = !0, this._loader.waitCall = t, void this._loader.loadXML(e))
        },
        _v: function (e) {
        ...
        loadUpdate: function () {
            var e = this,
                ...
                i = this.serverProcessor + getUrlSymbol(this.serverProcessor) + ["sar_user=" + this._user, "sar_version=" + t].join("&");
    ...
    }), sarvanamError.catchError("LoadXML", function (e, t, i) {
        ...
        sarvanamEventable(scheduler), scheduler._detachDomEvent = function (e, t, i) {
            ...
            var i = e();
            sarvanamEvent(window, "resize", function () {
                var s = e();
            ...
            this.set_xy(this._els.sar_cal_navline[0], e, this.xy.nav_height, 0, 0),
                this.set_xy(this._els.sar_cal_header[0], e - i, this.xy.scale_height, s, this.xy.nav_height + (this._quirks ? -1 : 1));
            var a = this._els.sar_cal_navline[0].offsetHeight;
            a > 0 && (this.xy.nav_height = a);
            var n = this.xy.scale_height + this.xy.nav_height + (this._quirks ? -2 : 0);
            this.set_xy(this._els.sar_cal_data[0], e, t - (n + 2), 0, n + 2)
        ...
        scheduler.setCurrentView(scheduler.date.add(scheduler.date[scheduler._mode + "_start"](scheduler._date), t || 1, scheduler._mode))
            ...
            buttons: {
                "delete": function (e) {
                    ...
                    scheduler._sarvanam_confirm(t, scheduler.locale.labels.title_confirm_deleting, function () {
        ...
        }, scheduler._sarvanam_confirm = function (e, t, i) {
            if (!e) return i();
            var s = {
                text: e
            };
            ...
            if (t = t || e.target || e.srcElement, !this.config.readonly) {
                ...
                switch (i) {
                    case "sar_scale_holder":
                    case "sar_scale_holder_now":
                    case "sar_month_body":
                    case "sar_wa_day_data":
                    ...
                    case "sar_cal_event":
                    case "sar_wa_ev_body":
                    case "sar_agenda_line":
                    case "sar_grid_event":
                    case "sar_cal_event_line":
                    case "sar_cal_event_clear":
            ...
            t = _isIE || !e.pageX && !e.pageY ? {
                ...
                x: e.pageX,
                y: e.pageY
            }, t.x -= getAbsoluteLeft(this._obj) + (this._table_view ? 0 : this.xy.scale_width), t.y -= getAbsoluteTop(this._obj) + this.xy.nav_height + (this._dy_shift || 0) + this.xy.scale_height - this._els.sar_cal_data[0].scrollTop, t.ev = e;
            ...
            if ((new Date).valueOf() - (scheduler._new_event || 0) > 500 && scheduler._edit_id) {
                ...
                scheduler._sarvanam_confirm(e, scheduler.locale.labels.title_confirm_closing, function () {
            ...
            var s = 1 * e + scheduler._get_fictional_event_length(e, t, i);
            return new Date(1 * s - (scheduler._get_fictional_event_length(s, -1, i, -1) + 1))
                ...
                if (t.force_redraw || this._is_pos_changed(this._drag_pos, t)) {
                    ...
                    if (this._drag_pos = t, this._drag_pos.has_moved = !0, "create" == this._drag_mode) {
                        ...
                        var n = new Date(this._drag_start),
                            r = new Date(s);
                        "day" != this._mode && "week" != this._mode || n.getHours() != r.getHours() || n.getMinutes() != r.getMinutes() || (r = new Date(this._drag_start + 1e3)),
                            this._drag_id = this.uid(), this.addEvent(n, r, this.locale.labels.new_event, this._drag_id, t.fields), this.callEvent("onEventCreated", [this._drag_id, e]), this._loading = !1, this._drag_mode = "new-size"
                    }
                    ...
                    i = this._correct_shift(i), t._ignores && this.config.preserve_length && this._table_view ? (i = scheduler._correct_drag_start_date(i), s = scheduler._correct_drag_end_date(i, this._drag_event._event_length)) : s = o.end_date.valueOf() - (o.start_date.valueOf() - i);
                    else {
                        if (i = o.start_date.valueOf(), s = o.end_date.valueOf(), this._table_view) {
                            ...
                            else t.resize_from_start ? i = scheduler._correct_drag_start_date(l) : s = scheduler._correct_drag_end_date(l, 0)
                        } else s = this.date.date_part(new Date(o.end_date.valueOf() - 1)).valueOf() + t.y * this.config.time_step * 6e4, this._els.sar_cal_data[0].style.cursor = "s-resize", ("week" == this._mode || "day" == this._mode) && (s = this._correct_shift(s));
                    ...
                    var c = new Date(s - 1),
                        u = new Date(i);
                    if ("move" == this._drag_mode && scheduler.config.limit_drag_out && (+u < +scheduler._min_date || +s > +scheduler._max_date)) {
                        if (+o.start_date < +scheduler._min_date || +o.end_date > +scheduler._max_date) u = new Date(o.start_date), s = new Date(o.end_date);
                        else {
                            var g = s - u; +u < +scheduler._min_date ? (u = new Date(scheduler._min_date), t._ignores && this.config.preserve_length && this._table_view ? (u = new Date(scheduler._correct_drag_start_date(u)),
                                d._start_correction && (u = new Date(u.valueOf() + d._start_correction)), s = new Date(1 * u + this._get_fictional_event_length(u, this._drag_event._event_length, d))) : s = new Date(+u + g)) : (s = new Date(scheduler._max_date), t._ignores && this.config.preserve_length && this._table_view ? (d._end_correction && (s = new Date(s.valueOf() - d._end_correction)), s = new Date(1 * s - this._get_fictional_event_length(s, 0, d, !0)), u = new Date(1 * s - this._get_fictional_event_length(s, this._drag_event._event_length, d, !0)), this._ignores_detected && (u = scheduler.date.add(u, d.x_step, d.x_unit),
                                s = new Date(1 * s - this._get_fictional_event_length(s, 0, d, !0)), s = scheduler.date.add(s, d.x_step, d.x_unit))) : u = new Date(+s - g))
                        }
                        var c = new Date(s - 1)
                    }
                    ...
                    if (this._table_view || c.getDate() == u.getDate() && c.getHours() < this.config.last_hour || scheduler._allow_dnd)
                        if (o.start_date = u, o.end_date = new Date(s), this.config.update_render) {
                            var f = scheduler._els.sar_cal_data[0].scrollTop;
                            this.update_view(), scheduler._els.sar_cal_data[0].scrollTop = f
                        } else this.updateEvent(this._drag_id);
                    this._table_view && this.for_rendered(this._drag_id, function (e) {
                        e.className += " sar_in_move"
            ...
            if (2 != e.button && !this.config.readonly && !this._drag_mode) {
                ...
                switch (i) {
                    ...
                    case "sar_wa_ev_body":
                        ...
                        break;
                    case "sar_event_resize":
                        this._drag_mode = "resize", scheduler._drag_from_start = (t.className || "").indexOf("sar_event_resize_end") < 0 ? !0 : !1;

                        break;
                    case "sar_scale_holder":
                    case "sar_scale_holder_now":
                    case "sar_month_body":
                    case "sar_matrix_cell":
                    case "sar_marked_timespan":
                    ...
                    case "":
                        ...
                        break;
                    default:
                        if ((!scheduler.checkEvent("onMouseDown") || scheduler.callEvent("onMouseDown", [i])) && t.parentNode && t != this && "sar_body" != i) return scheduler._on_mouse_down(e, t.parentNode);
            ...
            if (!e || 2 != e.button || !scheduler.config.touch) {
                if (this._drag_mode && this._drag_id) {
                    this._els.sar_cal_data[0].style.cursor = "default";
                    var t = this._drag_id,
                        i = this._drag_mode,
                        s = !this._drag_pos || this._drag_pos.has_moved,
                        a = this.getEvent(this._drag_id);
                    if (s && (this._drag_event._sar_changed || !this._drag_event.start_date || a.start_date.valueOf() != this._drag_event.start_date.valueOf() || a.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                        ...
                        else n ? this.deleteEvent(a.id, !0) : (this._drag_event._sar_changed = !1,
            ...
            var i = "sar_cal_data";
            this._mode ? this._obj.className = this._obj.className.replace("sar_scheduler_" + this._mode, "sar_scheduler_" + t) : this._obj.className += " sar_scheduler_" + t;
            ...
            a = a || 0;
            var n = document.createElement("DIV");
            n.className = "sar_scale_bar", this.templates[this._mode + "_scalex_class"] && (n.className += " " + this.templates[this._mode + "_scalex_class"](i));
            var r = this._cols[e] - 1;
            "month" == this._mode && 0 === e && this.config.left_border && (n.className += " sar_scale_bar_border",
            ...
            for (var l = 0; d > l; l++) {
                if (this._ignores[l] || this._render_x_header(l, o, r, e), !this._table_view) {
                    var h = document.createElement("DIV"),
                        _ = "sar_scale_holder";
                    r.valueOf() == a.valueOf() && (_ = "sar_scale_holder_now"), this._ignores_detected && this._ignores[l] && (_ += " sar_scale_ignore"), h.className = _ + " " + this.templates.week_date_class(r, a), this._set_scale_col_size(h, this._cols[l], o), t.appendChild(h), this.callEvent("onScaleAdd", [h, r])
                }
                o += this._cols[l], r = this.date.add(r, 1, "day"), r = this.date.day_start(r)
            }
        }, scheduler._reset_scale = function () {
            if (this.templates[this._mode + "_date"]) {
                var e = this._els.sar_cal_header[0],
                    t = this._els.sar_cal_data[0],
                    i = this.config;

                e.innerHTML = "", t.innerHTML = "";
                var s = (i.readonly || !i.drag_resize ? " sar_resize_denied" : "") + (i.readonly || !i.drag_move ? " sar_move_denied" : "");
                t.className = "sar_cal_data" + s, this._scales = {}, this._cols = [], this._colsS = {
                    height: 0
                }, this._dy_shift = 0, this.set_sizes();
                var a, n, r = this._get_timeunit_start(),
                    d = scheduler._get_view_end();
                if (a = n = this._table_view ? scheduler.date.week_start(r) : r, this._min_date = a, this._els.sar_cal_date[0].innerHTML = this.templates[this._mode + "_date"](r, d, this._mode), this._max_date = d, scheduler._render_scales(e, t),
                    ...
                    var l = this._els.sar_cal_navline[0],
                        h = l.offsetHeight + this._els.sar_cal_header[0].offsetHeight + 1,
                    ...
                    var c = _.cloneNode(!0);
                    c.className = o + "_icon", c.style.visibility = "hidden", this.set_xy(c, this.xy.scale_width, 0, 0, h), _.appendChild(c), this._els[o] = [_, c], this._els[o][0].onclick = this._click.sar_cal_data
                }
            }
        }, scheduler._reset_hours_scale = function (e, t, i) {
            var s = document.createElement("DIV");
            s.className = "sar_scale_holder";
            for (var a = new Date(1980, 1, 1, this.config.first_hour, 0, 0), n = 1 * this.config.first_hour; n < this.config.last_hour; n++) {
                var r = document.createElement("DIV");
                r.className = "sar_scale_hour", r.style.height = this.config.hour_size_px - (this._quirks ? 0 : 1) + "px";

                var d = this.xy.scale_width;
                this.config.left_border && (d -= 1, r.className += " sar_scale_hour_border"), r.style.width = d + "px", r.innerHTML = scheduler.templates.hour_scale(a), s.appendChild(r), a = this.date.add(a, 1, "hour")
            }
            ...
            for (var _ = 0, c = "<table cellpadding='0' cellspacing='0'>", u = [], l = 0; d > l; l++) {
                ...
                for (var g = Math.max(s(l) - scheduler.xy.month_head_height, 0), f = 0; 7 > f; f++) {
                    c += "<td";
                    var v = "";
                    t > i ? v = "sar_before" : i >= a ? v = "sar_after" : i.valueOf() == r.valueOf() && (v = "sar_now"), this._ignores_detected && this._ignores[f] && (v += " sar_scale_ignore"),
                        c += " class='" + v + " " + this.templates.month_date_class(i, r) + "' >";
                    var m = "sar_month_body",
                        p = "sar_month_head";
                    0 === f && this.config.left_border && (m += " sar_month_body_border", p += " sar_month_head_border"), this._ignores_detected && this._ignores[f] ? c += "<div></div><div></div>" : (c += "<div class='" + p + "'>" + this.templates.month_day(i) + "</div>", c += "<div class='" + m + "' " + o[f] + ";height:" + g + "px;'></div></td>"), u.push(i);
                    var x = i.getDate();
            ...
            var s, a = t - e,
                ...
                d = 0;
            i.render ? (d = this._get_date_index(i, e), s = this._get_date_index(i, t)) : s = Math.round(a / 60 / 60 / 1e3 / 24);

            for (var o = !0; s > d;) {
                var l = scheduler.date.add(t, -i.x_step, i.x_unit);
                r && r(t) && (!o || o && r(l)) ? a -= t - l : (o = !1, a -= n), t = l, s--
            }
            return a
            ...
            month_start: function (e) {
                ...
                var t = new Date(e);
                var currentdate = t.getDate();
              
                return e.setDate(currentdate), this.date_part(e)
            },
            ...
            buttons_left: ["sar_save_btn", "sar_cancel_btn"],
            buttons_right: ["sar_delete_btn"],
            lightbox: {
                sections: [{
                    name: "description",
                    height: 200,
            ...
            ajax_error: "alert",
            delay_render: 0,
            timeline_swap_resize: !1
        }, scheduler.templates = {}, scheduler.init_templates = function () {
            var e = scheduler.locale.labels;
            e.sar_save_btn = e.icon_save, e.sar_cancel_btn = e.icon_cancel, e.sar_delete_btn = e.icon_delete;
            ...
            function () {
                ...
                if (this.config.multi_day && !this._table_view) {
                    ...
                    this._rendered_location = this._els.sar_multi_day[0], this._table_view = !0, this.render_data(n, t), this._table_view = !1, this._rendered_location = this._els.sar_cal_data[0], this._table_view = !1, this.render_data(a, t)
                } else this._rendered_location = this._els.sar_cal_data[0], this.render_data(e, t)
                ...
                for (var t = this._rendered_location, i = this._lame_clone(e), s = e._sday; s < e._eday; s++) {
                    ...
                    }, l.className = "sar_month_link", l.style.top = d.y + "px", l.style.left = d.x + "px", l.style.width = o + "px", l.innerHTML = scheduler.templates.month_events_link(n, r), this._rendered.push(l), t.appendChild(l)
                }
                ...
                for (var t = 0; t < e.length; t++)
                    if (-1 == (e[t].className || "").indexOf("sar_scale_ignore")) return e[t];
                return e[0]
                        ...
                        if (r.rows) {
                            ...
                            if (a.unshift(0), r.parentNode.offsetHeight < r.parentNode.scrollHeight && !scheduler._colsS.scroll_fix && scheduler.xy.scroll_width) {
                                var c = scheduler._colsS,
                                    u = c[c.col_length],
                                    g = c.heights.slice();
                                u -= scheduler.xy.scroll_width || 0, this._calc_scale_sizes(u, this._min_date, this._max_date), scheduler._colsS.heights = g, this.set_xy(this._els.sar_cal_header[0], u, this.xy.scale_height), scheduler._render_scales(this._els.sar_cal_header[0]), scheduler._render_month_scale(this._els.sar_cal_data[0], this._get_timeunit_start(), this._min_date), c.scroll_fix = !0
                            }
                        } else if (e.length || "visible" != this._els.sar_multi_day[0].style.visibility || (a[0] = -1), e.length || -1 == a[0]) {
                            var f = (r.parentNode.childNodes, (a[0] + 1) * i + 1),
                                v = f,
                                m = f + "px";
                            this.config.multi_day_height_limit && (v = Math.min(f, this.config.multi_day_height_limit), m = v + "px"), n.style.top = this._els.sar_cal_navline[0].offsetHeight + this._els.sar_cal_header[0].offsetHeight + v + "px", n.style.height = this._obj.offsetHeight - parseInt(n.style.top, 10) - (this.xy.margin_top || 0) + "px";
                            var p = this._els.sar_multi_day[0];
                            p.style.height = m, p.style.visibility = -1 == a[0] ? "hidden" : "visible";
                            var x = this._els.sar_multi_day[1];
                            x.style.height = m, x.style.visibility = -1 == a[0] ? "hidden" : "visible",
                                x.className = a[0] ? "sar_multi_day_icon" : "sar_multi_day_icon_small", this._dy_shift = (a[0] + 1) * i, this.config.multi_day_height_limit && (this._dy_shift = Math.min(this.config.multi_day_height_limit, this._dy_shift)), a[0] = 0, v != f && (n.style.top = parseInt(n.style.top) + 2 + "px", p.style.overflowY = "auto", x.style.position = "fixed", x.style.top = "", x.style.left = "")
                        }
                    }
                return e
                ...
                if (!(e._sday < 0)) {
                    ...
                    if (s) {
                        ...
                        if (this._rendered.push(g), s.appendChild(g), h = h + parseInt(s.style.left, 10) + i, this._edit_id == e.id) {
                            g.style.zIndex = 1, l = Math.max(l - 4, scheduler.xy.editor_width), g = document.createElement("DIV"), g.setAttribute("event_id", e.id), this.set_xy(g, l, r - 20, h, n + 14), g.className = "sar_cal_event sar_cal_editor";
                            ...
                            this.set_xy(v, l - 6, r - 26), v.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", g.appendChild(v),
                                this._els.sar_cal_data[0].appendChild(g), this._rendered.push(g), v.innerHTML = "<textarea class='sar_cal_editor'>" + e.text + "</textarea>", this._quirks7 && (v.firstChild.style.height = r - 12 + "px"), this._editor = v.firstChild, this._editor.onkeydown = function (e) {
                                ...
                                this._els.sar_cal_data[0].scrollLeft = 0
                        }
                        if (0 !== this.xy.menu_width && this._select_id == e.id) {
                            this.config.cascade_event_display && this._drag_mode && (g.style.zIndex = 1);
                            for (var m = this.config["icons_" + (this._edit_id == e.id ? "edit" : "select")], p = "", x = e.color ? "background-color: " + e.color + ";" : "", b = e.textColor ? "color: " + e.textColor + ";" : "", y = 0; y < m.length; y++) p += "<div class='sar_menu_icon " + m[y] + "' style='" + x + b + "' title='" + this.locale.labels[m[y]] + "'></div>";
                            var w = this._render_v_bar(e, h - t + 1, n, t, 20 * m.length + 26 - 2, "", "<div style='" + x + b + "' class='sar_menu_head'></div>", p, !0);

                            w.style.left = h - t + 1, this._els.sar_cal_data[0].appendChild(w), this._rendered.push(w)
                        }
                ...
                var l = document.createElement("DIV"),
                    h = e.id,
                    _ = o ? "sar_cal_event sar_cal_select_menu" : "sar_cal_event",
                ...
                v = l.firstChild;
                var m = '<div class="sar_event_move sar_header" style=" width:' + (s - 6) + "px;" + u + '" >&nbsp;</div>';
                m += '<div class="sar_event_move sar_title" style="' + u + g + '">' + r + "</div>", m += '<div class="sar_body" style=" width:' + (s - (this._quirks ? 4 : 14)) + "px; height:" + (a - (this._quirks ? 20 : 30) + 1) + "px;" + u + g + '">' + d + "</div>";
                var p = "sar_event_resize sar_footer";
                return o && (p = "sar_resize_denied " + p), m += '<div class="' + p + '" style=" width:' + (s - 8) + "px;" + (o ? " margin-top:-1px;" : "") + u + g + '" ></div>',
                    v.innerHTML = m, v
            }, scheduler.renderEvent = function () {
                return !1
            }, scheduler.locate_holder = function (e) {
                return "day" == this._mode ? this._els.sar_cal_data[0].firstChild : this._els.sar_cal_data[0].childNodes[e]
                ...
                if (n) {
                    var d = scheduler.config.resize_month_events && "month" == this._mode && (!e._timed || scheduler.config.resize_month_timed),
                        ...
                        _ = d && (e._timed || l),
                        c = d && (e._timed || h),
                        u = "sar_cal_event_clear";
                    (!e._timed || d) && (u = "sar_cal_event_line"), l && (u += " sar_cal_event_line_start"), h && (u += " sar_cal_event_line_end"),
                        _ && (r += "<div class='sar_event_resize sar_event_resize_start'></div>"), c && (r += "<div class='sar_event_resize sar_event_resize_end'></div>");
                ...
                t.className = "sar_drag_marker", i && (t.className += " " + i), s && (t.innerHTML = s), this._append_drag_marker(t)
                ...
                if (e = e || this._load_url) {
                    ...
                    if (t = t || this._date, this._load_mode) {
                        ...
                        if (t >= i) return !1;
                        for (sarvanamAjax.get(e + "&from=" + s(t) + "&to=" + s(i), function (e) {
                                scheduler.on_load(e)
                        }) ; i > t;) this._loaded[s(t)] = !0, t = this.date.add(t, 1, this._load_mode)
                    } else sarvanamAjax.get(e, function (e) {
                        scheduler.on_load(e)
                    });
                ...
                "string" == typeof data && (scheduler._temp = eval("(" + data + ")"), data = scheduler._temp ? scheduler._temp.data || scheduler._temp.d || scheduler._temp : []), data.sar_security && (sarvanam.security_key = data.sar_security);
        ...
        scheduler.parse = function (e, t) {
                ...
                if (!e.getXMLTopNode) {
                    ...
                    e = new srmXMLLoaderObject(function () { }), e.loadXMLString(i)
                }
                if (t = e.getXMLTopNode("data"), "data" != t.tagName) return null;
                var s = t.getAttribute("sar_security");
                s && (sarvanam.security_key = s);
                ...
                if (this.config.show_loading === !0) {
                    var e;
                    e = this.config.show_loading = document.createElement("DIV"), e.className = "sar_loading", e.style.left = Math.round((this._x - 128) / 2) + "px", e.style.top = Math.round((this._y - 15) / 2) + "px", this._obj.appendChild(e)
                }
                ...
                template: {
                    render: function (e) {
                        ...
                        return "<div class='sar_cal_ltext sar_cal_template' style='height:" + t + ";'></div>"
                    },
                ...
                textarea: {
                    render: function (e) {
                        ...
                        return "<div class='sar_cal_ltext' style='height:" + t + ";'><textarea></textarea></div>"
                    },
                ...
                select: {
                    render: function (e) {
                        for (var t = (e.height || "23") + "px", i = "<div class='sar_cal_ltext' style='height:" + t + ";'><select style='width:100%;'>", s = 0; s < e.options.length; s++) i += "<option value='" + e.options[s].key + "'>" + e.options[s].label + "</option>";
                        return i += "</select></div>"
                    },
                    set_value: function (e, t, i, s) {
                        var a = e.firstChild;
                        !a._sar_onchange && s.onchange && (a.onchange = s.onchange, a._sar_onchange = !0), "undefined" == typeof t && (t = (a.options[0] || {}).value),
                            a.value = t || ""
                    },
                    get_value: function (e, t) {
                        return e.firstChild.value
                ...
                time: {
                    render: function (e) {
                        ...
                        return "<div style='height:30px;padding-top:0px;font-size:inherit;' class='sar_section_time'>" + r + "<span style='font-weight:normal; font-size:10pt;'> &nbsp;&ndash;&nbsp; </span>" + r + "</div>"
                    },
                    set_value: function (e, t, i, s) {
                        function a(e, t, i) {
                        ...
                        if (d.full_day) {
                            if (!e._full_day) {
                                var h = "<label class='sar_fullday'><input type='checkbox' name='full_day' value='true'> " + scheduler.locale.labels.full_day + "&nbsp;</label></input>";
                ...
                if (!this._cover) {
                    this._cover = document.createElement("DIV"), this._cover.className = "sar_cal_cover";
            ...
            scheduler._init_lightbox_events = function () {
                this.getLightbox().onclick = function (e) {
                    ...
                    if (t.className || (t = t.previousSibling), t && t.className) switch (t.className) {
                        ...
                        case "sar_delete_btn":
                            ...
                            scheduler._sarvanam_confirm(i, scheduler.locale.labels.title_confirm_deleting, function () {
                ...
                sarvanamEvent(document.body, "mousemove", scheduler._move_while_dnd),
                    sarvanamEvent(document.body, "mouseup", scheduler._finish_dnd), scheduler._init_dnd_events = function () { }
            }, scheduler._move_while_dnd = function (e) {
                if (scheduler._dnd_start_lb) {
                    document.sar_unselectable || (document.body.className += " sar_unselectable", document.sar_unselectable = !0);
                ...
                scheduler._lb_start && (scheduler._lb_start = scheduler._dnd_start_lb = !1, document.body.className = document.body.className.replace(" sar_unselectable", ""), document.sar_unselectable = !1)
            }, scheduler.getLightbox = function () {
                if (!this._lightbox) {
                    var e = document.createElement("DIV");

                    e.className = "sar_cal_light", scheduler.config.wide_form && (e.className += " sar_cal_light_wide"), scheduler.form_blocks.recurring && (e.className += " sar_cal_light_rec"), /msie|MSIE 6/.test(navigator.userAgent) && (e.className += " sar_ie6"), e.style.visibility = "hidden";
                    for (var t = this._lightbox_template, i = this.config.buttons_left, s = 0; s < i.length; s++) t += "<div class='sar_btn_set sar_left_btn_set " + i[s] + "_set'><div sar_button='1' class='" + i[s] + "'></div><div>" + scheduler.locale.labels[i[s]] + "</div></div>";
                    i = this.config.buttons_right;

                    for (var s = 0; s < i.length; s++) t += "<div class='sar_btn_set sar_right_btn_set " + i[s] + "_set' style='float:right;'><div sar_button='1' class='" + i[s] + "'></div><div>" + scheduler.locale.labels[i[s]] + "</div></div>";
                    ...
                    for (var s = 0; s < a.length; s++) {
                        ...
                        if (n) {
                            ...
                            var r = "";
                            a[s].button && (r = "<div class='sar_custom_button' index='" + s + "'><div class='sar_custom_button_" + a[s].button + "'></div><div>" + this.locale.labels["button_" + a[s].button] + "</div></div>"), this.config.wide_form && (t += "<div class='sar_wrap_section'>");
                            var d = this.locale.labels["section_" + a[s].name];
                            "string" != typeof d && (d = a[s].name), t += "<div id='" + a[s].id + "' class='sar_cal_lsection'>" + r + d + "</div>" + n.render.call(this, a[s]),
                                t += "</div>"
                        }
                    }
                    for (var o = e.getElementsByTagName("div"), s = 0; s < o.length; s++) {
                        var l = o[s];
                        if ("sar_cal_larea" == l.className) {
                            l.innerHTML = t;
                            break
                        }
                    }
            ...
            }), scheduler._lightbox_template = "<div class='sar_cal_ltitle'><span class='sar_mark'>&nbsp;</span><span class='sar_time'></span><span class='sar_title'></span></div><div class='sar_cal_larea'></div>",
            scheduler._init_touch_events = function () {
                ...
                function a(e, t, i, s) {
                    if (e && t) {
                        ...
                        if (a == scheduler._obj) {
                            ...
                            s > n && r > i && (!n || r / n > 3) && (e.pageX > t.pageX ? scheduler._click.sar_cal_next_button() : scheduler._click.sar_cal_prev_button())
                        }
                    }
                }
                ...
                }), s(this._els.sar_cal_data[0], "scroll", r), s(this._els.sar_cal_data[0], "touchcancel", r), s(this._els.sar_cal_data[0], "contextmenu", function (e) {
                    return c ? (e && e.preventDefault && e.preventDefault(), (e || event).cancelBubble = !0, !1) : void 0
                }), s(this._els.sar_cal_data[0], e[1], function (e) {
                    if (!i(e)) {
                        var s;
                        if (h = _ = !1, c = !0, scheduler._temp_touch_block = !0, s = o = t(e), !s) return void (_ = !0);
                        var a = new Date;
                        if (!_ && !h && 250 > a - u) return scheduler._click.sar_cal_data(s), window.setTimeout(function () {
                        ...
                        if (u = a, !_ && !h && scheduler.config.touch_drag) {
                            ...
                            if (n && r && n == r && n != g) return e.preventDefault && e.preventDefault(),
                                e.cancelBubble = !0, scheduler._ignore_next_click = !1, scheduler._click.sar_cal_data(s), d = s, !1;
                            l = setTimeout(function () {
                                h = !0;
                                var e = d.target;
                                e && e.className && -1 != e.className.indexOf("sar_body") && (e = e.previousSibling), scheduler._on_mouse_down(d, e), scheduler._drag_mode && "create" != scheduler._drag_mode && scheduler.for_rendered(scheduler._drag_id, function (e, t) {
                ...
                }), s(this._els.sar_cal_data[0], e[2], function (e) {
                ...
                }), sarvanamEvent(document.body, e[2], r)
            }, scheduler._show_global_tip = function () {
                scheduler._hide_global_tip();
                var e = scheduler._global_tip = document.createElement("DIV");
                e.className = "sar_global_tip", scheduler._update_global_tip(1), document.body.appendChild(e);
                ...
                }), e._objToJson = function (t, i, s) {
                    s = s || "", i = i || {};
                    for (var a in t) 0 !== a.indexOf("_") && (t[a] && t[a].getUTCFullYear ? i[s + a] = this.obj.templates.xml_format(t[a]) : t[a] && "object" == typeof t[a] ? e._objToJson(t[a], i, s + a + ".") : i[s + a] = t[a]);
                    return i
                ...
                if (!scheduler.skin)
                    for (var e = document.getElementsByTagName("link"), t = 0; t < e.length; t++) {
                        var i = e[t].href.match("sarvanamscheduler_([a-z]+).css");
                        if (i) {
                            scheduler.skin = i[1];
                            break
                        }
                ...
                if (!scheduler.skin || "classic" !== scheduler.skin && "glossy" !== scheduler.skin || (s = 1), this._configure(scheduler.config, scheduler._skin_settings, s), this._configure(scheduler.xy, scheduler._skin_xy, s), "flat" === scheduler.skin && (scheduler.xy.scale_height = 35, scheduler.templates.hour_scale = function (e) {
                        var t = e.getMinutes();
                        t = 10 > t ? "0" + t : t;
                        var i = "<span class='sar_scale_h'>" + e.getHours() + "</span><span class='sar_scale_m'>&nbsp;" + t + "</span>";
                    ...
                    a && (a.padding = 14), scheduler.templates.event_bar_date = function (e, t, i) {
                        ...
                        if (scheduler.templates.month_day = function (i) {
                                if ("month" == this._mode) {
                                    var s = e(i);
                                    return 1 == i.getDate() && (s = scheduler.locale.date.month_full[i.getMonth()] + " " + s), +i == +scheduler.date.date_part(new Date) && (s = scheduler.locale.labels.sar_cal_today_button + " " + s), s
                        }
                                return t.call(this, i)
                        }, scheduler.config.fix_tab_position) {
                            for (var i = scheduler._els.sar_cal_navline[0].getElementsByTagName("div"), s = null, a = 211, n = 0; n < i.length; n++) {
                                var r = i[n],
                                    d = r.getAttribute("name");
                                if (d) switch (r.style.right = "auto", d) {
                                    case "day_tab":
                                        r.style.left = "14px", r.className += " sar_cal_tab_first";
                                        break;
                                    case "week_tab":
                                        r.style.left = "75px";
                                        break;
                                    case "month_tab":
                                        r.style.left = "136px", r.className += " sar_cal_tab_last";

                                        break;
                                    default:
                                        r.style.left = a + "px", r.className += " sar_cal_tab_standalone", a = a + 14 + r.offsetWidth
                                } else 0 === (r.className || "").indexOf("sar_minical_icon") && r.parentNode == scheduler._els.sar_cal_navline[0] && (s = r)
                            }
                            s && (s.style.left = a + "px")
                        }
                    }), scheduler._skin_init = function () { }
                ...
                var t = 0,
                    i = [];
                e.fn.sar_scheduler = function (s) {
                    if ("string" != typeof s) {
                        var a = [];
                        return this.each(function () {
                            if (this && this.getAttribute)
                                if (this.getAttribute("sarscheduler")) a.push(window[this.getAttribute("sarscheduler")]);
                                else {
                                    var e = "scheduler";
                                    t && (e = "scheduler" + (t + 1), window[e] = Scheduler.getSchedulerInstance());
                                    var i = window[e];
                                    this.setAttribute("sarscheduler", e);
                                    for (var n in s) "data" != n && (i.config[n] = s[n]);
                                    this.getElementsByTagName("div").length || (this.innerHTML = '<div class="sar_cal_navline"><div class="sar_cal_prev_button">&nbsp;</div><div class="sar_cal_next_button">&nbsp;</div><div class="sar_cal_today_button"></div><div class="sar_cal_date"></div><div class="sar_cal_tab" name="day_tab" style="right:204px;"></div><div class="sar_cal_tab" name="week_tab" style="right:140px;"></div><div class="sar_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="sar_cal_header"></div><div class="sar_cal_data"></div>',
                                        this.className += " sar_cal_container"), i.init(this, i.config.date, i.config.mode), s.data && i.parse(s.data), a.push(i), t++
                                }
                        }), 1 === a.length ? a[0] : a
                    }
                    return i[s] ? i[s].apply(this, []) : void e.error("Method " + s + " does not exist on jQuery.sar_scheduler")
                }
            }(jQuery),
            function () {
                function e(e, t, i) {
    ...
    }, window.scheduler = Scheduler.getSchedulerInstance(), sarvanam && sarvanam.attaches && (sarvanam.attaches.attachScheduler = function (e, t, i, s) {
        var i = i || '<div class="sar_cal_tab" name="day_tab" style="right:204px;"></div><div class="sar_cal_tab" name="week_tab" style="right:140px;"></div><div class="sar_cal_tab" name="month_tab" style="right:76px;"></div>',
            a = document.createElement("DIV");
        return a.id = "sarSchedObj_" + this._genStr(12),
            a.innerHTML = '<div id="' + a.id + '" class="sar_cal_container" style="width:100%; height:100%;"><div class="sar_cal_navline"><div class="sar_cal_prev_button">&nbsp;</div><div class="sar_cal_next_button">&nbsp;</div><div class="sar_cal_today_button"></div><div class="sar_cal_date"></div>' + i + '</div><div class="sar_cal_header"></div><div class="sar_cal_data"></div></div>', document.body.appendChild(a.firstChild), this.attachObject(a.id, !1, !0), this.vs[this.av].sched = s, this.vs[this.av].schedId = a.id, s.setSizes = s.updateView,
